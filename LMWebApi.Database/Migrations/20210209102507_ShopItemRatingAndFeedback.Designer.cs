...
namespace LMWebApi.Database.Migrations
{
    ...
    [Migration("20210209102507_ShopItemRatingAndFeedback")]
    partial class ShopItemRatingAndFeedback
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMWebApi.Database.Models.ShopItemFeedback", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("LMWebApi.Database.Models.ShopItemFeedback", b =>
                {
                    b.HasOne("LMWebApi.Database.Models.ShopItem", "ShopItem")
                        .WithMany("Feedbacks")
                        .HasForeignKey("ShopItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LMWebApi.Database.Models.User", "User")
